...
- 用紙は **A4・横**。
- 印刷したら、**下辺の「✂ ここで切る」の点線に沿ってハサミで切る**。
  紋章はこの線でちょうど半分に切れる設計。点線は紙の下辺から 6.5mm 内側に
  あるので、フチなし印刷ができないプリンタでも紋章が欠けない。
  切らないと謎は解けないので、参加者に配る前に必ず切っておくこと。
...
- **矢印は切り取り線に垂直にする。** 手紙の文字は斜め45°の格子状に
